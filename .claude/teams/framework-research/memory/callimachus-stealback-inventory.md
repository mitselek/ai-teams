...
**Purpose:** Single coordinated patch spec for `prompts/callimachus.md` bundling 12 patterns lifted from `apex-migration-research/.claude/teams/apex-research/prompts/eratosthenes.md` (v2.7.1). Authored as prep artifact, not patch. Celes executes the edits.
...
**Target prompt:** `.claude/teams/framework-research/prompts/callimachus.md`
