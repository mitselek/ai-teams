...
[DECISION] **File placement: `containers/xireactor-pilot/` at repo root.** Serves two teams; `.claude/teams/framework-research/pilots/` would create ownership illusion. Repo-root signals shared cross-team substrate.
