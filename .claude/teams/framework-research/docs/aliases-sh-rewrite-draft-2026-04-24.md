...
> Source file lives in `apex-migration-research/.claude/teams/apex-research/aliases.sh`
...
#              prompt="You are <persona>. Read .claude/teams/apex-research/prompts/<agent>.md,
...
- **Target path:** `.claude/teams/apex-research/aliases.sh`
