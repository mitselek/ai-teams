...
- `.claude/teams/entu-research/memory/*.md` — scratchpads
...
- `.claude/teams/entu-research/memory/lesseps.md` — your scratchpad
...
Your scratchpad is at `.claude/teams/entu-research/memory/lesseps.md`.
