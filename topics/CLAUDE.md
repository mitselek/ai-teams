...
Doc-index signpost (Tier 2 navigation). The eight numbered topic files are the framework's design surface; 09 is the development-methodology synthesis. Not a behavioral contract.

## Contents
- 01-team-taxonomy.md -- types and organization of AI agent teams
- 02-resource-isolation.md -- how teams avoid stepping on each other's work
- 03-communication.md -- how teams communicate with each other and with humans
- 04-hierarchy-governance.md -- supervision chains, escalation, approval authority, decision delegation
- 05-identity-credentials.md -- authentication scoping and secret access per team
- 06-lifecycle.md -- spawning, scaling, shutdown, and handover of teams
...
- 11-deployment-lifecycle.md -- CCR (Coordinated Container Rebuild): deploy-surface convention + PR-review + windowed rebuild; teams own content, FR gates activation
