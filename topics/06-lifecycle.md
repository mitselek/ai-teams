...
>
> **New sequence:** **Orient → Sync → Discover → Restore → Restart-courier → Audit → Spawn**. (_Restore-before-Restart-courier corrected in S58, Bug A -- see the Restart-courier bullet._)
>
