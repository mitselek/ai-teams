...
SYSTEM_PROMPT = open("dev-toolkit/.claude/teams/cloudflare-builders/prompts/eilama-system.txt").read()
...
| Startup | `python3 dev-toolkit/.claude/teams/eilama-daemon.py &` |
