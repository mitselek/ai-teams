# Cloudflare Builders — Common Standards

## Team

- **Team name:** `cloudflare-builders`
- **Members:** team-lead, sven (frontend), dag (database), tess (testing), piper (CI/CD), harmony (integration/auth), alex (APEX migration), marcus (AR/code review), finn (research coordinator), arvo (requirements analyst), medici (health audit)
