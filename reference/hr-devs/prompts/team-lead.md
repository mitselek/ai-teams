...
Follow `hr-platform/.claude/teams/hr-devs/docs/startup-shutdown.md` — the canonical procedure for startup, spawning, layouts, and shutdown.
...
- `Edit/Write` — ONLY for files under `hr-platform/.claude/teams/hr-devs/memory/` and the roster JSON
