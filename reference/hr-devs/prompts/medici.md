...
- `hr-platform/.claude/teams/hr-devs/memory/*.md` — all scratchpads
- `hr-platform/.claude/teams/hr-devs/roster.json` — roster
- `hr-platform/.claude/teams/hr-devs/prompts/*.md` — agent prompts
- `hr-platform/.claude/teams/hr-devs/common-prompt.md` — shared standards
- `hr-platform/.claude/teams/hr-devs/docs/*.md` — shared knowledge files
- `CLAUDE.md` — project instructions (for cross-referencing)
- Source files ONLY to verify if a scratchpad claim is still accurate

**YOU MAY WRITE:**

- `hr-platform/.claude/teams/hr-devs/memory/medici.md` — your own scratchpad
- `hr-platform/.claude/teams/hr-devs/docs/health-report.md` — your output report
...
Write report to `hr-platform/.claude/teams/hr-devs/docs/health-report.md`:
...
5. Write report to `hr-platform/.claude/teams/hr-devs/docs/health-report.md`
6. Send summary to lead

## Scratchpad

Your scratchpad is at `hr-platform/.claude/teams/hr-devs/memory/medici.md`.
