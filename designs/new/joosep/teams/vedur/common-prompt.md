...
| **Any change to the message-centre endpoint routing or the reserved train-number ranges** | **Ruth Türk** signs off, **mediated by Mihkel** | STOP. Report. Do not proceed on anyone else's word, including Joosep's |
