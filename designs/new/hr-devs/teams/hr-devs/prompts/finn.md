...
- Write, edit, or create any files other than `hr-platform/teams/hr-devs/memory/finn.md`
...
Your scratchpad is at `hr-platform/teams/hr-devs/memory/finn.md`. Keep it under 100 lines — prune completed research entries after delivery. Use tags:
