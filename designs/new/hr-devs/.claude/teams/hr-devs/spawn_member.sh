...
# Adapted from hr-platform/.claude/teams/hr-devs/spawn_member.sh with fixes:
...
ROSTER="$HOME/workspace/hr-platform/.claude/teams/hr-devs/roster.json"
PROMPTS_DIR="$HOME/workspace/hr-platform/.claude/teams/hr-devs/prompts"
