...
**Team location:** `hr-platform/.claude/teams/hr-devs/`
**Spawn script:** `hr-platform/.claude/teams/hr-devs/spawn_member.sh`
**Roster:** `hr-platform/.claude/teams/hr-devs/roster.json`

## Startup

### Step 0: Read prompts and sync

1. Read `hr-platform/.claude/teams/hr-devs/prompts/team-lead.md`
2. Read `hr-platform/.claude/teams/hr-devs/common-prompt.md`
3. Read `hr-platform/.claude/teams/hr-devs/roster.json`
4. Read `hr-platform/.claude/teams/hr-devs/memory/lead.md` (scratchpad, if exists)
...
```bash
cd ~/github/dev-toolkit/agent-dashboard && CLAUDE_TEAM_DIR=~/github/hr-platform/.claude/teams/hr-devs CLAUDE_TEAM_NAME=hr-devs node server.ts &
...
```bash
~/github/hr-platform/.claude/teams/hr-devs/spawn_member.sh <agent-name> [tmux-session]
```
...
4. Save task list to `hr-platform/.claude/teams/hr-devs/memory/task-list-snapshot.md`
