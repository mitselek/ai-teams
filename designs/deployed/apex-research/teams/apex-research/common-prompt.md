...
| `teams/apex-research/memory/` | each agent owns their own file | Schliemann reads all |
...
1. Read your personal scratchpad at `teams/apex-research/memory/<your-name>.md` if it exists
...
Each teammate maintains a scratchpad at `teams/apex-research/memory/<your-name>.md`.
