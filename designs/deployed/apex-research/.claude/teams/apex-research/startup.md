...
| Item | Path |
|---|---|
| Team config repo dir | `$REPO/.claude/teams/apex-research/` |
| Working directory | `$REPO/` |
| Runtime team dir | `$TEAM_DIR/` |
| Roster | `.claude/teams/apex-research/roster.json` (relative to repo) |
| Common prompt | `.claude/teams/apex-research/common-prompt.md` |
| Agent prompts | `.claude/teams/apex-research/prompts/*.md` |
| Scratchpads | `.claude/teams/apex-research/memory/*.md` |
...
REPO="$(git rev-parse --show-toplevel)"
TEAM_DIR="$HOME/.claude/teams/apex-research"
REPO_INBOXES="$REPO/.claude/teams/apex-research/inboxes"
