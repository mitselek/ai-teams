...
- `Edit/Write` — ONLY for files under `.claude/teams/apex-research/memory/`, `dashboard/data/agents.json`, and roster
...
Your scratchpad is at `.claude/teams/apex-research/memory/schliemann.md`.
