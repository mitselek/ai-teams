...
This index is the single entry point to the wiki. On startup, the Librarian
reads this file to re-orient on wiki state. Every wiki entry should be
discoverable from here, either directly or through one of the subdirectory
tables below.
