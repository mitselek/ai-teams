...
**Design artifacts:**
- `teams/framework-research/docs/persist-coverage-design-v0.1.md` — solo draft (Volta)
- `teams/framework-research/docs/persist-coverage-design-v0.2.md` — Brunel cross-read integrated
- `teams/framework-research/docs/persist-coverage-design-v0.3.md` — team-lead refinements integrated

**Implementation** (framework-research substrate, 2026-04-14):
- `teams/framework-research/persist-project-state.sh` — 2997 bytes, mirror semantics, marker-primary discovery, `--dry-run` support
- `teams/framework-research/persist-session-logs.sh` — 4691 bytes, MANIFEST-aware tarball builder, age-floor retention via `find -mtime +7`, `--dry-run` support
- `teams/framework-research/restore-project-state.sh` — 2382 bytes, merge semantics
- `teams/framework-research/restore-session-logs.sh` — 1975 bytes, MANIFEST display + confirmation prompt
- `teams/framework-research/.project-dir-name` — marker file containing `C--Users-mihkel-putrinsh-Documents-github`
