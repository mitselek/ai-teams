...
- Helper comment block must call out that the opt-in is intended to be **team-local** (`teams/<team>/.gitignore` or similarly narrow-scope), NOT repo-root.
