...
source-docs:
  ...
  - teams/framework-research/wiki/patterns/bootstrap-preamble-as-in-band-signal-channel.md
  - teams/framework-research/wiki/patterns/governance-staging-for-agent-writes.md
...
| Write destination | `$REPO/teams/FR/wiki/<dir>/<slug>.md` | xireactor `entries` table under FR-private or FR-owned shared-read zone | **reshaped substrate, preserved shape** |
