...
Your scratchpad is at `teams/framework-research/memory/volta.md`. Open with the Summary header (lines 1-15) per common-prompt Personal Scratchpads; keep under 100 lines, prune the transcript at session-end.
