...
- `teams/framework-research/prompts/*.md` -- agent prompts (to understand team governance conventions)
...
- `teams/framework-research/memory/montesquieu.md` -- your own scratchpad
...
Your scratchpad is at `teams/framework-research/memory/montesquieu.md`. Open with the Summary header (lines 1-15) per common-prompt Personal Scratchpads; keep under 100 lines, prune the transcript at session-end.
