...
- Evidence: Schliemann's apex T14, delivered over the live hub; folded into onboarding Appendix B as customer-#2 worked example. Confidence high on model-holds; stage-2 pending Herald read-back (Schliemann = external original observer).
