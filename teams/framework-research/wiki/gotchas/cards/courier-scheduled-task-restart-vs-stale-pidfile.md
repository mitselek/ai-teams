...
stage-2: pending
related: [windows-user-context-persistent-bridge.md, inbox-file-write-as-wake-mechanism.md]
tags: [gotcha, courier, windows, task-scheduler, pidfile, restart, singleton]
---
...
- **stage-2: pending** -- filed-on-behalf (Brunel); single-incident observation, awaiting read-back.
