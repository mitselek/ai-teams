...
- **Ownership ruled 2026-08-28 (team-lead): NOT a new work item.** The upgrade is already carried by the **S65 a1.2 EVR-island formation spec** (`docs/evr-island-hub-formation-spec-2026-08-27.md`) and is a **PO keyboard item** -- host-side, outside FR's execution remit. **This entry is the record of WHY it is required, not a parallel request for it.**
