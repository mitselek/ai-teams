---
title: "Operational Team Archetype"
directory: patterns
status: active
...
stage-2: confirmed
related: [multi-repo-xp-composition.md, cathedral-trigger-quality-teams.md, model-tiering-by-consequence.md, claude-startup-md-as-cross-team-handoff.md]
tags: [team-archetype, operational-team, succession, taxonomy, n1-watch, speculative]
---

## TLDR

A new team archetype distinct from research, development, and XP-pipeline teams, recognized by four co-occurring characteristics. Any one alone is not the archetype; the cluster is.
