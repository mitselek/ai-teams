...
|---|---|---|---|
| claude-opus-4-6 | 43 | 63% | Team-leads, ARCHITECT, PURPLE, code reviewers, design specialists, researchers, Librarian |
...
Roster files across: `reference/`, `designs/deployed/`, `designs/new/`, `teams/`
