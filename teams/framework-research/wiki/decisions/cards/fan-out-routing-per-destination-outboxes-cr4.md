...
- Codified in onboarding ("Outbox routing") + courier-hints Outbound §3. Confidence high (ratified + n=2 independent-implementation). stage-2 pending Herald read-back.
