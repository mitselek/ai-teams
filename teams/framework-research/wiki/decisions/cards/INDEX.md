...
**Stage-2-confirms gate** (#70): each card carries a `stage-2` field. decisions/ -- **7 confirmed, 1 partial** (single-source/authoritative-pointer = confirmed; stationmaster confirmed via Aen read-back 2026-06-12; the two S51 stationmaster decisions -- fan-out CR-4 + §4 text-field errata -- confirmed via Herald read-back 2026-06-15). Partial: courier-must-runtime-discover-team-name (filed-on-behalf of Hopper/Brunel 2026-06-17; **Brunel read back 2026-06-18 → partial**; Hopper read-back still owed for confirmed). The 2026-06-18 WS2 batch (filed-on-behalf Herald, issue #86) -- lifecycle-release-evaporates-under-implicit-teams + startup-create-collapses-to-discover -- both **confirmed via Herald full-entry read-back 2026-06-18**. Audit: `grep -rl 'stage-2: pending\|stage-2: partial' decisions/cards/`.
