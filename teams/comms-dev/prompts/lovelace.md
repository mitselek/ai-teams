...
- All project files: `comms-relay/`, `teams/comms-dev/`, specs, docs
...
Your scratchpad is at `$REPO/teams/comms-dev/memory/lovelace.md` (where `REPO="$(git rev-parse --show-toplevel)"`).
